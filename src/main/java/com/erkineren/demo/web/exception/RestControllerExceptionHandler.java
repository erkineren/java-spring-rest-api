...
import com.erkineren.demo.web.payload.response.ExceptionResponse;
...
public class RestControllerExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> resolveException(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity<>(new ExceptionResponse(messages, HttpStatus.BAD_REQUEST.getReasonPhrase()), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ExceptionResponse> resolveException(HttpRequestMethodNotSupportedException ex) {
        ...
        return new ResponseEntity<>(new ExceptionResponse(messages, HttpStatus.METHOD_NOT_ALLOWED.getReasonPhrase()), HttpStatus.METHOD_NOT_ALLOWED);
    }
    ...
    @ResponseBody
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseEntity<ExceptionResponse> resolveException(IllegalArgumentException ex) {
        List<String> messages = new ArrayList<>(1);
